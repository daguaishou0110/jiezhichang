window.JOURNAL_SURVEY = {
  "meta": {
    ...
    "caveat": "本站分区一律按 2026 新锐大类，不再使用中科院 2025 升级版。投前请用 xr-scholar.com 复核，并以贵单位认定口径为准。写法占比仅一区已抽样刊有数字。",
    "updated": "2026-08",
  ...
  "zones": [
    ...
    },
    {
      ...
      "name": "二区",
      "status": "roster",
      "blurb": "2026 新锐大类二区。公开数据预测 / 生信方法 / 影像方法常落点。写法占比尚未抽样。",
      "journals": [
        {
          "id": "jmir_med_inform",
        ...
        },
        {
          ...
          "xr": {
            ...
            "zone": 2,
            "top": false,
            "minor": "数字健康（投前复核单位是否认 Frontiers）"
          },
          "track": "数字医学",
          "fit": "mid",
          "fit_label": "数字健康二区",
    ...
    },
    {
      ...
      "name": "三区",
      "status": "roster",
      "blurb": "2026 新锐大类三区。验证偏弱时的现实出口；含部分 Mega 刊。对外勿包装成一区。",
      "journals": [
        {
          "id": "bone",
          "name": "Bone",
    ...
    },
    {
      ...
      "name": "四区",
      "status": "roster",
      "blurb": "2026 新锐大类四区。仅内部备胎。Heliyon 等可能带 Under Review，投前必查。",
      "journals": [
        {
          "id": "jxrst",
